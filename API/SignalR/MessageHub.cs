...
public class MessageHub : Hub
{
	...
	public override async Task OnConnectedAsync()
	{
		...
		if(_uow.HasChanges()) _uow.Complete();
	...
	public async Task SendMessage(CreateMessageDto createMessageDto)
	{
		...
		}else
		{
			...
			if(connections != null)
			{
				await _presenceHub.Clients.Clients(connections).SendAsync("NewMessageReceived", new {sender = sender.UserName, knownAs = sender.KnownAs});
			}
		}
